...
|----------|------------------------------------------|-----------------------------------------------------------------------------|----------------|
| ✅ 1      | **Retail Sales Analysis**               | Exploratory Data Analysis (EDA) on retail sales to derive insights.         | [View Notebook](./OIBSIB_TASK_1/Diya_retail_sales_analysis.ipynb) |
| ✅ 2      | **Customer Segmentation**               | Clustering customers using K-Means based on behavioral data.                | [View Notebook](./OIBSIB_TASK_2/Diya_CUSTOMER_SENTIMENT_ANALYSIS.ipynb) |
| ✅ 3      | **Data Cleaning**                       | Cleaned and preprocessed a real-world dataset from Airbnb listings.         | [View Notebook](./OIBSIB_TASK_3/Diya_CLEANING_DATASET.ipynb) |
| ✅ 4      | **Sentiment Analysis**                  | Analyzing Twitter data for positive/negative sentiment using NLP.           | [View Notebook](./OIBSIB_TASK_4/Diya_SENTIMMENT_ANALYSIS.ipynb) |
